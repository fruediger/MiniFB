...
{
    private const string NativeImportAttributesNamespaceName = $"{nameof(MiniFB)}.{nameof(SourceGeneration)}";
    ...
    private const string GeneratedAttributesOutputFileName = $"{nameof(MiniFB)}.{nameof(SourceGeneration)}.NativeImportAttributes.g.cs";
